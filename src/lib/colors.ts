...
const COLOR_LABELS: Record<string, string> = {
  ...
  orange: 'Orange', 'cosmic orange': 'Orange cosmique',
  coral: 'Corail', corail: 'Corail',
  graphite: 'Graphite',
  mauve: 'Mauve',
  lilac: 'Lilas', lilas: 'Lilas',
  // Couleurs Foxway génériques + marketing récentes (iPhone 16/17, Samsung, Pixel)
  mint: 'Menthe', menthe: 'Menthe',
  beige: 'Beige',
  brown: 'Marron', marron: 'Marron',
  teal: 'Bleu canard',
  lime: 'Vert citron',
  'ice blue': 'Bleu glacier', 'bleu glacier': 'Bleu glacier',
