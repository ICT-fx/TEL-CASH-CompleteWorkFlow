// Étape 3 (v5) — Sélecteur d'état VISUEL coque/écran en SCHÉMAS dessinés
// (illustrations SVG d'iPhone, finition titane, lentilles avec relief, écran
// Dynamic Island + reflets, rayures crédibles selon le grade).
//
// On revient aux dessins : A = neuf (aucune rayure), B = quelques micro-rayures,
// C = rayures visibles. Toggle Coque/Écran géré en JS. Les props optionnelles
// `imageCoque`/`imageEcran` permettent de remplacer un schéma par une vraie
// photo macro plus tard sans changer le reste.
...
type St = 'a' | 'b' | 'c'; // niveau d'usure de l'illustration
...
interface Props {
  ...
  /** Remplace le schéma par une vraie photo macro (optionnel, par état). */
