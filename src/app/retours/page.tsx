    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-16 p-6 bg-slate-100 rounded-2xl text-sm text-slate-600">
          ...
          <p>Contactez-nous via la <Link href="/contact" className="text-primary underline">page contact</Link> ou par email à <a href="mailto:infos@telandcash.fr" className="text-primary underline">infos@telandcash.fr</a>.</p>
        </div>
      </div>
    </div>
  );
