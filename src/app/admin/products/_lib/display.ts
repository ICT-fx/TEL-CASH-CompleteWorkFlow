// Display helpers shared between the flat catalog row and the grouped model row.

// Normalise any stored grade value (legacy FR labels or A/B/C) to a letter for display.
